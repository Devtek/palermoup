...
<ul class="nav navbar-nav upstyle-nav">
                ...
                <li><a style="background-color: #ffffff;">About</a></li>
    ...
    <div class="container marketing">
      ...
      <div class="row ">
        <div class="col-lg-12 backgroundSection">
         <h1> Cosa è PalermoUp?</h1>
		 <p><b>Palermo-UP</b> è un raccoglitore di <b>novità</b> riguardanti la città di Palermo, puoi trovare notizie di qualsiasi genere e dell’ultimo minuto.</p>
		   <h2> Come funziona?</h2>
			<p>Le informazioni vengono <b>raccolte</b> dalle principali testate presenti sul web (che trattano di cronaca, eventi ed interessi di Palermo e dei Palermitani) aggiornate in <b>tempo reale</b>.</p>
			<h3>Perchè?</h3>
		 <p> Palermo-UP ti permette di accedere ad <b>un solo sito web per informarti rapidamente</b>, inoltre puoi passare direttamente sul sito ufficiale specifico.</p>
		<p>Rimani informato, Stay Palermo-up!</p>
</p>
		</div> 
		</div>
